...
#SBATCH -o ../log/out_tree_subject_%a
#SBATCH -e ../log/err_tree_subject_%a
#SBATCH -D ./
...
# Run R script
srun singularity exec /ptmp/containers/tobi-datascience-r_latest-2021-12-15-e1eefd13aa83.sif Rscript fit_subject_tree.R $SLURM_ARRAY_TASK_ID
